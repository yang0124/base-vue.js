        ...
        <div class="store-content">
            <div class="cart-box">
                ...
                <div class="cart-inner">
                    <div class="empty-label" v-if="cartData.length==0">
                        <h3>您的购物车中还没有商品</h3>
                    ...
                    <div  v-if="cartData.length!=0">
                        ...
                        <div class="cart-table">
                            <div class="cart-group">
                                <!--购物列表-->
                                <div class="cart-top-items" v-for="(item,index) in cartData" :key="index">
                                    <div class="cart-items">
                                        ...
                                        <div class="subtotal">¥{{item.cnum*item.price}}</div>
                ...
                <div class="cart-bottom-bg fix-bottom" v-if="cartData.length!=0">
                    <div class="cart-bar-operation">
                        <div>
                            <div class="choose-all js-choose-all">
                                <span 
                                class="blue-checkbox-new" 
                                :class="allInfo.allCheck?'checkbox-on':''" 
...
export default {
    ...
    methods: {
        handleCheck(idx){ //单选按钮点击事件
            this.$store.commit('cartCheckMut',idx)
        },
        handleAllCheck(bool){ //全选按钮点击事件
