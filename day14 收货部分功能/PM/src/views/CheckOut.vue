  ...
  <div id="main">
			<div class="content page-order-checkout checkout">
				<div class="js-checkout-address-box">
                  ...
                  :key="index" 
                  :class="item.isDefault?'selected-address-item':''">
                        ...
                        {{item.address}} 
										...
										<div class="operation-section">
											<span class="update-btn js-edit-address" @click="handlePopShow(index)">修改</span>
											<span class="delete-btn js-delete-address">删除</span>
										</div>
									</li>
									<li @click="handlePopShow(-1)" class="add-address-item js-add-address">
										<p>使用新地址</p>
									</li>
								</ul>
							</div>
...
.checkout .address-item-list li:hover .operation-section{
