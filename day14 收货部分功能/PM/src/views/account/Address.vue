  ...
  <div class="account-address">
        <div class="gray-box clear">
            <div class="title pre-title">
                ...
                <span class="gray-blue-btn js-add-address"  @click="handlePopShow(-1)">
                    <a class="add">添加新地址</a>
                </span>
            </div>
            <div class="box-inner clear">
                <div class="address-list-item default-item" v-for="(item,index) in addressInfo" :key="index">
                    <div class="name fn-left">
                        <div class="name-cell">{{item.username}}</div>
                    </div>
                    ...
                    <div class="operation fn-right">
                        <div class="operation-cell">
                            <a class="gray-edit-btn js-edit-address" @click="handlePopShow(index)">修改</a>
                            <span class="red-del-btn js-del-address"> <a>删除</a><em>删除</em> </span>
                        </div>
                    </div>
                    <div class="default fn-right">  （默认地址）  </div>
...
export default {
    data() {
      return { 
        isShow: false,
        idx:-1   //0~其他数字标志当前被编辑地址的下标，-1代表新增地址
      }
    },
    components:{
        AddressPop
